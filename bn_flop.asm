...
_dkL1                  LDA  $1c00	; wait for end of Sync
                       ...
                       DEY  		;
                       BNE  _dkL1	; wait max. $8000 times
                       DEX  		;
                       BNE  _dkL1	;
                       LDY  #$40	; track consists of neverending Sync
                       RTS  		; -> $40 = $ff killer track
...
_dkL2                  DEY  		;
                       ...
                       DEX  		;
                       BEQ  _no_bytes	; timeout, not enough bytes found ->
_dkWait                BVC  _dkL2	;
                       CLV  		;
                       DEC  $c0		; check for at least $c0 bytes in track
                       BNE  _dkWait	;

                       LDY  #$00	; track contains at least $c0 bytes
                       RTS  		; -> $00 = track OK

_no_bytes              LDY  #$80	; track doesn't contain any bytes
                       RTS  		; -> $80 = track not formatted
...
_scJ7                  CLV  		;
                       ...
                       LDY  #$00	;
_scL3                  LDA  $00c4,Y	; transfer density statistic 1-5 to C64
                       JSR  _send_byte	; parallel-send data byte to C64
                       INY  		;
                       CPY  #$04	;
                       BNE  _scL3	;
